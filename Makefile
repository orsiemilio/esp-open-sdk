...
VENDOR_SDK_DIR_2.2.0-28-g89920dc = ESP8266_NONOS_SDK-2.2.0-28-g89920dc
...
$(VENDOR_SDK_DIR_2.2.0-28-g89920dc)/.dir:
	echo $(VENDOR_SDK_DIR_2.2.0-28-g89920dc)
	git clone https://github.com/espressif/ESP8266_NONOS_SDK $(VENDOR_SDK_DIR_2.2.0-28-g89920dc)
	(cd $(VENDOR_SDK_DIR_2.2.0-28-g89920dc); git checkout 89920dcc40)
	touch $@
...
.sdk_patch_2.2.0-28-g89920dc .sdk_patch_2.2.0: user_rf_cal_sector_set.o
